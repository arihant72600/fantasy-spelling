...
$stmt="SELECT league_name,creatorid, user_id_2, user_id_3, user_id_4, user_id_5, has_drafted FROM leagues WHERE league_id=$lid";
...
$stmt="SELECT team_id, speller_id_1, speller_id_2, speller_id_3, speller_id_4, speller_id_5, speller_id_6, speller_id_7, speller_id_8, speller_id_9, speller_id_10, score FROM teams WHERE league_id=$lid AND user_id=$c";
$row=$conn->query($stmt)->fetch_assoc();
$cscore=$row["score"];
$ctid=$row["team_id"];
...
$stmt="SELECT team_id, speller_id_1, speller_id_2, speller_id_3, speller_id_4, speller_id_5, speller_id_6, speller_id_7, speller_id_8, speller_id_9, speller_id_10, score FROM teams WHERE league_id=$lid AND user_id=$u2";
$row=$conn->query($stmt)->fetch_assoc();
$u2score=$row["score"];
$u2tid=$row["team_id"];
...
$stmt="SELECT team_id, speller_id_1, speller_id_2, speller_id_3, speller_id_4, speller_id_5, speller_id_6, speller_id_7, speller_id_8, speller_id_9, speller_id_10, score FROM teams WHERE league_id=$lid AND user_id=$u3";
$row=$conn->query($stmt)->fetch_assoc();
$u3score=$row["score"];
$u3tid=$row["team_id"];
...
$stmt="SELECT team_id, speller_id_1, speller_id_2, speller_id_3, speller_id_4, speller_id_5, speller_id_6, speller_id_7, speller_id_8, speller_id_9, speller_id_10, score FROM teams WHERE league_id=$lid AND user_id=$u4";
$row=$conn->query($stmt)->fetch_assoc();
$u4score=$row["score"];
$u4tid=$row["team_id"];
...
$stmt="SELECT team_id, speller_id_1, speller_id_2, speller_id_3, speller_id_4, speller_id_5, speller_id_6, speller_id_7, speller_id_8, speller_id_9, speller_id_10, score FROM teams WHERE league_id=$lid AND user_id=$u5";
$row=$conn->query($stmt)->fetch_assoc();
$u5score=$row["score"];
$u5tid=$row["team_id"];
...
$allstuff=array($cstuff,$u2stuff,$u3stuff,$u4stuff,$u5stuff);
...
h1{font-size:2.6rem;line-height:normal;margin-top:0;font-weight:300;}
h2{font-size:1.4rem;font-weight:300;line-height:normal;margin-top:1rem;margin-bottom:.5rem}
h3{font-size:1.4rem;font-weight:300;line-height:normal;margin:1rem 0 .5rem}
h4{font-size:1.1rem;font-weight:500;line-height:normal;margin-bottom:.4rem}
h6{font-size:1rem;font-weight:500;line-height:normal}
